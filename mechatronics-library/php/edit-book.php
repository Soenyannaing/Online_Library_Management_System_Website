        ...
        if (!empty($_FILES['book_cover']['name'])) {
		    ...
		    **/
		    if (!empty($_FILES['file']['name'])) {
		        ...
		        # book file Uploading
                $allowed_file_exs = array("pdf", "docx", "pptx", "doc", "xls", "xlsx", "txt", "tiff", "rtf", "csv");
		        $path = "files";
		        ...
		        if ($book_cover['status'] == "error" || 
		          ...
		          **/
		           ...
		           $book_cover_URL = $book_cover['data'];
					...
					$res  = $stmt->execute([$title, $year, $description, $category,$book_cover_URL, $file_URL, $id]);
		           ...
		           $book_cover_URL = $book_cover['data'];
		            ...
		            # update just the data
		          	$sql = "UPDATE books
		          	        ...
		          	        WHERE id=?";
		          	$stmt = $conn->prepare($sql);
					$res  = $stmt->execute([$title, $year, $description, $category,$book_cover_URL, $id]);
	        ...
	        if ($file['status'] == "error") {
	          ...
	          **/
	           $file_URL = $file['data'];
	            ...
	            # update just the data
	          	$sql = "UPDATE books
	          	        ...
	          	        WHERE id=?";
	          	$stmt = $conn->prepare($sql);
				$res  = $stmt->execute([$title, $year, $description, $category, $file_URL, $id]);
          	...
          	$sql = "UPDATE books
          	        ...
          	        WHERE id=?";
          	$stmt = $conn->prepare($sql);
			$res  = $stmt->execute([$title, $year, $description, $category, $id]);
