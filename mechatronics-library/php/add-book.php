	...
	**/
	...
	if (isset($_POST['book_title'])       &&
		...
		**/
		...
		$user_input = 'title='.$title.'&category_id='.$category.'&desc='.$description.'&year_id='.$year;
        ...
        $location = "../add-book.php";
        $ms = "error";
		is_empty($year, $text, $location, $ms, $user_input);
		    ...
		    **/
		    if ($file['status'] == "error") {
		        ...
		        **/
			    ...
			    $res  = $stmt->execute([$title, $year, $description, $category, $book_cover_URL, $file_URL]);
