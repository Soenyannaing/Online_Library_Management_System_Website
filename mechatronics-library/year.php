...
$books = get_books_by_year($conn, $id);
...
<?php
    ...
    try {
        ...
        $stmt = $conn->prepare("SELECT * FROM books WHERE year_id = :categoryId ORDER bY id DESC LIMIT :offset, :limit");
        ...
        $totalStmt = $conn->prepare("SELECT COUNT(*) FROM books WHERE year_id = :categoryId ORDER bY id DESC");
    ...
    <div class="result"><b>Results: <b><?= $year['name'] ?></b>
    </div>
